...
export const experiencesData = [
  {
    ...
    mustExperience: [
      ...
      'Authentic Rajasthani Dining & Cultural Performances'
    ],
    closingLine: 'Experience Jaipur not just as a destination, but as a journey through India\'s royal heritage.'
  },
  {
    id: 2,
    ...
    paragraphs: [
      ...
      'Whether you\'re seeking adventure, photography, or a tranquil escape into nature, the Jaisalmer Desert promises experiences that stay with you forever.'
    ],
    mustExperience: [
      'Camel Safari across the Sam Sand Dunes',
      'Thrilling 4×4 Jeep Desert Safari',
      'Sunset on the Golden Dunes',
      'Luxury Desert Camp Stay',
      'Folk Music & Kalbelia Dance Performances',
      'Traditional Rajasthani Dinner',
      'Stargazing Under the Desert Sky',
      'Sunrise Over the Thar Desert',
      'Explore the Golden Jaisalmer Fort (UNESCO World Heritage Site)',
      'Visit Patwon Ki Haveli & Gadisar Lake'
    ],
    closingLine: 'From golden dunes to unforgettable nights beneath the stars, every desert adventure with DuneXplore is crafted to inspire, excite, and create memories that last a lifetime.'
  },
  {
    id: 3,
    slug: 'udaipur-luxury',
    ...
    paragraphs: [
      ...
      'Whether you\'re celebrating a honeymoon, a special occasion, or simply looking to escape the ordinary, Udaipur promises an experience where every moment is crafted with elegance and care.'
    ],
    mustExperience: [
      'Stay at a Luxury Heritage Palace Hotel',
      'Private Boat Cruise on Lake Pichola',
      'Sunset at the City Palace',
      'Fine Dining with Lake Views',
      'Luxury Spa & Wellness Therapies',
      'Explore the City Palace & Crystal Gallery',
      'Visit Jag Mandir & Jagdish Temple',
      'Stroll through Saheliyon Ki Bari',
      'Discover Local Art & Miniature Painting Studios',
      'Rooftop Dining with Panoramic Lake Views'
    ],
    closingLine: 'From regal palace stays to moments of complete tranquility, Udaipur offers a luxurious escape where every experience reflects the grace and grandeur of Rajasthan.'
  }
];
